...
public class Skeleton extends MixedAttackerTroop {
    ...
    public Skeleton(double x, double y, String name, Speed speedType, MeleeRange melee, double mass,
    ...
    public Skeleton(int row, int col, String name, Speed speedType, MeleeRange melee, double mass,
        double collisionRadius, double loadTime, int hitPoints, int damage, Side side) {
