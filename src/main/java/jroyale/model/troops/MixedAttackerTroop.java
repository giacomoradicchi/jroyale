...
public abstract class MixedAttackerTroop extends Troop {
    ...
    public MixedAttackerTroop(String name, double x, double y, int healthPoints, int damage, Speed speedType, Range melee, Side side) {
        super(name, x, y, healthPoints, damage, speedType, melee, side);
    }

    public MixedAttackerTroop(String name, int n, int m, int healthPoints, int damage, Speed speedType, Range melee, Side side) {
