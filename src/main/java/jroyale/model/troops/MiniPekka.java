...
public class MiniPekka extends MixedAttackerTroop {
    ...
    public MiniPekka(double x, double y, String name, Speed speedType, MeleeRange melee, double mass,
    ...
    public MiniPekka(int row, int col, String name, Speed speedType, MeleeRange melee, double mass,
        double collisionRadius, double loadTime, int hitPoints, int damage, Side side) {
